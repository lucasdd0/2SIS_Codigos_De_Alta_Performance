            ...
            switch (opcao) {
                ...
                case 2:
                    if (fila.isEmpty()) {
                        ...
                        nome = fila.dequeue();
                        System.out.println("Processo em excecução: " + nome);
                        System.out.println("... O processo doi concluido? (1-sim): ");
                        int resp = sc.nextInt();
                        if(resp == 1){
                            System.out.println("Processo " + nome + "foi concluido com sucesso");
                        }else{
                            fila.enqueue(nome);
                            System.out.println("Processo " + nome + "voltou para fila");
                        }
                    }
                    break;
                case 3:
